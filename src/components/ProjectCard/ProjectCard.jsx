  ...
  return (
    <div className="w-full md:w-x mx-auto ">
        <div className="border border-gray-300 p-5 rounded-3xl space-y-3">
            ...
            <p className="px-2 text-3xl font-medium">{name}</p>
            <p className="px-2 text-gray-500">{description}</p>
            <a href={link}>
                <button className="flex items-center mx-2 mt-2 py-3 px-3 cursor-pointer w-32 hover:w-40 hover:bg-gray-300 duration-150 bg-gray-200 font-medium rounded-xl">Live Demo <span className="ml-auto ">
                {/* <IoMdOpen />  */}
                <IoIosArrowForward />
                </span>
            </button>
